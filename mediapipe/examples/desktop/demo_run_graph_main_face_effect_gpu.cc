...
absl::Status RunMPPGraph()
{
    ...
    MP_RETURN_IF_ERROR(graph.StartRun({
        {"use_face_detection_input_source", mediapipe::MakePacket<bool>(true)
                                                .At(mediapipe::Timestamp::Unstarted())}
    }));
    ...
    while (grab_frames)
    {
        ...
        // Send select effect id into the graph.
        MP_RETURN_IF_ERROR(graph.AddPacketToInputStream(
            "selected_effect_id", mediapipe::MakePacket<int>(0)
    ...
    MP_RETURN_IF_ERROR(graph.CloseInputStream("selected_effect_id"));
    MP_RETURN_IF_ERROR(graph.CloseInputStream("input_side_packet"));
